  ...
  return (
    <Wrapper>
      <Container>
        ...
        <BigTagBox>
          <BigTag>
            <Subscript>{challenge && challenge.startDay} ~ {challenge && challenge.endDay}</Subscript>
          </BigTag>
        </BigTagBox>
        <ContentBox>
          <ContentLarge>
              <Image src='https://health.chosun.com/site/data/img_dir/2018/09/10/2018091003038_0.jpg' alt='challenge' />
              <Desc>
                  <p>
                    <TextStrong>인증방법 및 주의사항</TextStrong><br/>
                    60일동안 하루에 1번 인증샷을 촬영하셔야 합니다.<br />
                    인증샷 피드에 인증샷이 공개됩니다.<br />
                    스마트워치 혹은 앱 화면 "캡쳐"만 가능합니다.<br />
                    - 동일한 사진으로 2번 이상 인증한 것으로 스탭이 판단하는 경우<br />
                    - 다른 회원들의 신고를 받으신 경우<br />
