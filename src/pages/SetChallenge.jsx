...
function SetChallenge() {
    ...
    const onSubmit = (data) => {
        console.log(data);
        axios.post('http://localhost:8082/api/challenge', {
            ...
            <Setting>
                <form onSubmit={handleSubmit(onSubmit)}>
                    <Wrapper>
                        ...
                        <InputText type='text' placeholder='챌린지명을 입력하세요' {...register('title', {
                            required : true,
                        ...
                        <ErrorMessage>
                            ...
                            {(watchStartDay && watchEndDay && totalDate < 7) && ' 설정 기간을 다시 확인하세요.'}
                        </ErrorMessage>
                        <SubTitle>
                            주간 실행 횟수
                        </SubTitle>
